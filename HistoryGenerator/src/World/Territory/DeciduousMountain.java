...
public class DeciduousMountain extends Territory {
    ...
    public static final Biome BIOME = Biome.DECIDUOUSMOUNTAIN;
    public DeciduousMountain(String location, int seed, String hrt, int size, final HashMap<Integer, River> rivers,
