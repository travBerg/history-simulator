...
public class DeciduousHills extends Territory {
    ...
    public static final Biome BIOME = Biome.DECIDUOUSHILLS;
    public DeciduousHills(String location, int seed, String hrt, int size, final HashMap<Integer, River> rivers,
