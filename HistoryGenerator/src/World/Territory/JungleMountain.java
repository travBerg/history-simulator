...
public class JungleMountain extends Territory {
    ...
    public static final Biome BIOME = Biome.JUNGLEMOUNTAIN;
    public JungleMountain(String location, int seed, String hrt, int size, final HashMap<Integer, River> rivers,
