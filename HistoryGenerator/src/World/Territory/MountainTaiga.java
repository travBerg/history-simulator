...
public class MountainTaiga extends Territory {
    ...
    public static final Biome BIOME = Biome.MOUNTAINTAIGA;
    public MountainTaiga(String location, int seed, String hrt, int size, final HashMap<Integer, River> rivers,
